...
export default function Entry() {
    return (
        <div id="entry">
            <img id="fuji" src="https://scrimba.com/links/travel-journal-japan-image-url" alt="mount fuji."/>
            <div id="info">
                <span id="marker">
                ...
                <p id="text">Mount Fuji is the tallest mountain in Japan, standing at 3,776 meters (12,380 feet). Mount Fuji is the single most popular tourist site in Japan, for both Japanese and foreign tourists.</p>
            </div>
        </div>
    )
}
