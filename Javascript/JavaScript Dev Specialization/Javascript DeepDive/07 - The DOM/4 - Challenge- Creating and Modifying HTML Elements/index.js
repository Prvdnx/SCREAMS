...
// const title = document.querySelector('h1');
// title.innerText = "Challenge: Creating and Modifying HTML Elements";

// const newHtml = document.createElement('h2');
// newHtml.className = 'tagline';
// newHtml.innerText = "I can create HTML elements!";
