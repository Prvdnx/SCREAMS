...
// printBio.apply(user, ['London', 'England']); // after the first argument, further arguments are added as an array[] when using 'apply' in this case
...
const user = {
  ...
  arrowFn: () => {
    console.log(this.first);  // Arrow => function don't have a 'this'
  }
}
